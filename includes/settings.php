    ...
    <div style="width:49%; float:right">
        <div class="postbox">
            ...
            <div style="padding:5px;">
                ...
                <p><span><?php _e('You are using', 'better-rss-widget'); ?> <strong> <a href="http://grandslambert.com/plugin/better-rss-widget/" target="_blank"><?php echo $this->pluginName; ?> <?php echo $this->version; ?></a></strong> by <a href="http://grandslambert.com" target="_blank">GrandSlambert</a>.</span> </p>
            </div>
            <h3 class="handl" style="margin:0; padding:3px;cursor:default;">
            ...
            <div style="padding:5px;">
                <p>
                    <?php printf(__('See the %1$s for this plugin for more details on what each of these settings does.', 'better-rss-widget'), '<a href="http://grandslambert.com/documentation/better-rss-widget/" target="_blank">' . __('Documentation Page', 'better-rss-widget') . '</a>');
                    ?>
                </p>
            </div>
            ...
            <div style="padding:8px;">
                <p>
                    <?php
                    printf(
                        __('Thank you for trying the %1$s plugin - I hope you find it useful. For the latest updates on this plugin, vist the %2$s. If you have problems with this plugin, please use our %3$s or check out the %4$s.', 'better-rss-widget'), $this->pluginName, '<a href="http://grandslambert.com/plugin/better-rss-widget/" target="_blank">' . __('official site', 'better-rss-widget') . '</a>', '<a href="https://wordpress.org/support/plugin/better-rss-widget" target="_blank">' . __('Support Forum', 'better-rss-widget') . '</a>', '<a href="http://grandslambert.com/documentation/better-rss-widget/" target="_blank">' . __('Documentation Page', 'better-rss-widget') . '</a>'
                    );
                    ?>
                </p>
                <p>
                    <?php
                    printf(
                        __('This plugin is &copy; %1$s by %2$s and is released under the %3$s', 'better-rss-widget'), '2009-' . date("Y"), '<a href="http://grandslambert.com" target="_blank">GrandSlambert</a>', '<a href="http://www.gnu.org/licenses/gpl.html" target="_blank">' . __('GNU General Public License', 'better-rss-widget') . '</a>'
                    );
                    ?>
                </p>
            </div>
            ...
            <div style="padding:8px">
                <p>
                    <?php printf(__('If you find this plugin useful, please consider supporting this and our other great %1$s.', 'better-rss-widget'), '<a href="http://grandslambert.com/plugins/" target="_blank">' . __('plugins', 'better-rss-widget') . '</a>'); ?>
                </p>
                <p style="text-align: center">
                    <a href="https://www.paypal.com/donate/?business=ZELD6TZ4T8KAL&no_recurring=0&item_name=Donate+to+the+Better+RSS+Widget.&currency_code=USD" target="_blank">
                        <?php _e('Donate a few bucks!', 'better-rss-widget'); ?>
                    </a>
                </p>
            </div>
        </div>
