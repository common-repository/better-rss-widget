...
Donate link: http://grandslambert.com/plugin/better-rss-widget/
...
= 2.8.1 - December 1st, 2022 =

* Removed the unused admin css and js as they were no longer needed.
* 

= 2.8.0 - November 22nd, 2022 =

* Updated the code to remove deprecated functions.
* Updated the widget call to use current WordPress functionality.
* Tested int 6.1.1 and it works again!
